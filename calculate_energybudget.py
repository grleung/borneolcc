"""
This script takes RAMS output and creates a netcdf file (.nc) that contains the
...
There is one netcdf file per run, which are saved under
 '/squall/gleung/borneolcc-analysis/paper-analysis/seb-diurnal-[run].nc'
"""
...
for run in runs:
    ...
    out.to_netcdf(
        f"/squall/gleung/borneolcc-analysis/paper-analysis/seb-diurnal-{run}.nc"
    )
